      ...
      <div className="container flex-col mx-auto ">
        <div className="flex flex-col sm:flex-row mt-8 justify-center">
          ...
          <div className="w-1/3 mt-0 ml-16 mr-0 sm:ml-0 sm:mr-5">
            ...
            <a
              href="mailto:meerlogix@gmail.com"
          ...
          <div className="w-1/3 ml-16 sm:ml-0 mt-0">
            ...
            <Button
              href="https://www.linkedin.com/in/meer-logix-a801b2388/"
              type="link"
              target="_blank"
              className="flex text-lg text-gray-400 font-light hover:underline"
              isExternal
            ...
            <Button
              href="https://github.com/meer-logix/Meer-Logix"
              type="link"
              target="_blank"
              className="flex text-lg text-gray-400 font-light hover:underline"
              isExternal
        ...
        <div className="flex-col text-center mt-7">
          <p className="text-lg text-gray-400 font-light">
            Copyright 2021 - All rights reserved - MeerLogix
          </p>
